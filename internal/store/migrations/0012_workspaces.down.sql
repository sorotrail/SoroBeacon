-- Reverses 0012. The unique-index swap goes back first, because the column it
...
ALTER TABLE monitor_templates  DROP COLUMN IF EXISTS workspace_id;
ALTER TABLE saved_searches     DROP COLUMN IF EXISTS workspace_id;
ALTER TABLE alerts             DROP COLUMN IF EXISTS workspace_id;
ALTER TABLE channels           DROP COLUMN IF EXISTS workspace_id;
ALTER TABLE monitors           DROP COLUMN IF EXISTS workspace_id;
