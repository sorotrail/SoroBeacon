...
func TestRegistry(t *testing.T) {
	r := NewRegistry()
	assert.ElementsMatch(t, []string{TypeEventEmitted, TypeValueThreshold, TypeEventNameGlob, TypeTokenEvent, TypeFrequencyThreshold, TypeTopicRegex, TypeAddressWatchlist}, r.Types())
