...
func TestRegistry(t *testing.T) {
	r := NewRegistry()
	assert.ElementsMatch(t, []string{TypeEventEmitted, TypeValueThreshold, TypeTokenSupplyChange, TypeTokenEvent, TypeFrequencyThreshold, TypeTopicRegex, TypeAddressWatchlist}, r.Types())
