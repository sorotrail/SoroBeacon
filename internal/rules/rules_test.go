...
func TestRegistry(t *testing.T) {
	r := NewRegistry()
	assert.ElementsMatch(t, []string{TypeEventEmitted, TypeValueThreshold, TypeContractAllowlist, TypeTokenEvent, TypeFrequencyThreshold, TypeTopicRegex, TypeAddressWatchlist}, r.Types())
